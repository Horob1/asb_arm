# Giải thích Bài 2-2 lab 7: Trừ hai ma trận 3x3
...
m3 DCB 0               ; Ma trận 3 sẽ lưu kết quả trừ của m1 và m2
...
Loop
    CMP R0, R4          ; Kiểm tra nếu đã trừ hết các phần tử
    ...
    SUBS R5, R5, R6     ; Trừ hai phần tử: R5 = R5 - R6
